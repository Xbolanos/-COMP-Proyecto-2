/ * * ? ? / 
 ...
 int C , p , t , J , a , m , e , s , T , K , i , r [ 16309 
  ] , [ 16309 
  ] [ 2 ] , c [ 16309 
  ] [ 2 ] , f = 1701 
  ; 
 fd_set O , d , o ; char g [ 8 ] [ 16309 
  ] , * h , j [ ] = "0\1&me\1&t&e\1TFTTJPO>" 
 ...
 imeofday ( & n , 0 ) ; 0 [ 3 [ g ] ] = 0 ; e = read ( G , 3 [ g ] , 16309 
  ) ; if ( e < 0 ) break ; else if ( e && * 3 [ g ] = = 72 ) { gettimeofday ( & q , 0 ) ; 3 [ g ] [ 16309 
  - 1 ] = 0 ; z ( 3 [ g ] , j + 41 ) ; if ( 0 [ 1 [ g ] ] ) if ( strnc 
 mp ( 1 [ g ] , 0 [ g ] , strlen ( 1 [ g ] ) ) ) { t = 0 ; if ( ( q . tv_sec - n . tv_sec ) * 1000000 + q . tv_usec - n . 
 tv_usec < 500000 
  - 1000 ) { t = p < 15 ? 1 : 16 ; p += t ; C += t ; } else p = p < 15 ? 15 : 255 ; if ( p = = 2 
 55 ) { putchar ( C ) ; fflush ( stdout ) ; C = p = 0 ; } } else { T = 1 ; goto l ; } } } } else { for ( f = 0 ; 
 f < 16309 
  ; f ++ ) { if ( ( i = fgetc ( stdin ) ) < 0 ) break ; f [ r ] = i ; } for ( i = 0 ; i < 16309 
  ; i ++ ) { 0 [ i [ ] ] 
 = 1 [ i [ ] ] = - 1 ; 0 [ i [ c ] ] = 1 [ i [ c ] ] = 0 ; } gettimeofday ( & n , 0 ) ; p = sprintf ( 5 [ g ] , j + 2 
 , n . tv_sec ) ; n . tv_sec = 0 ; n . tv_usec = 500000 
  ; FD_ZERO ( & d ) ; FD_ZERO ( & O ) ; F 
 D_ZERO ( & o ) ; l . sin_addr . s_addr = 0 ; l . sin_port = htons ( 1701 
  ) ; bind ( G = sock 
 ...
 } else if ( i || FD_ISSET ( J , & o ) ) { e = read ( J , 2 [ g ] , 16309 
  ) ; K = 0 ; if ( e > 0 ) { 
 2 [ g ] [ 16309 
  - 1 ] = 0 ; if ( * 2 [ g ] = = 71 ) { a = 0 ; strcpy ( 1 [ g ] , 0 [ g ] ) ; z ( 2 [ g ] , j + 
 45 ) ; if ( strncmp ( 0 [ g ] , 5 [ g ] , strlen ( 5 [ g ] ) ) && strncmp ( 1 [ g ] , 
 0 [ g ] , strlen ( 1 [ g ] ) ) ) { K = atoi ( 0 [ g ] + p ) ; } if ( K ) { if ( 0 [ K [ ] ] < f 
 ) { if ( a = ( 1 [ K [ ] ] < 15 ? 1 [ K [ ] ] : 1 [ K [ ] ] >> 4 ) > = ( 1 [ K [ ] ] < 15 ? 
 0 [ K [ ] ] [ r ] & 15 : 0 [ K [ ] ] [ r ] >> 4 ) ) 1 [ K [ ] ] = 1 [ K [ ] ] < 15 ? 1 
 5 : 255 ; else 1 [ K [ ] ] += 1 [ K [ ] ] < 16 ? 1 : 16 ; if ( [ K ] [ 1 ] = = 
 255 ) { 0 [ K [ ] ] ++ ; 1 [ K [ ] ] = 0 ; } } else { write ( 1 [ K [ c ] ] , [ 
 K ] , sizeof ( [ K ] ) ) ; close ( 1 [ K [ c ] ] ) ; K = 0 ; } } else fo 
 r ( s = 1 ; s < 16309 
  ; s ++ ) if ( 0 [ s [ ] ] = = - 1 ) { 0 [ s [ ] ] = 1 [ s [ ] ] 
 ...
 close ( J ) ; FD_CLR ( J , & o ) ; x ( J ) ; } else { write ( 1 [ K [ c ] ] , K [ ] , sizeof ( K [ 
 ] ) ) ; close ( 1 [ K [ c ] ] ) ; close ( J ) ; return 0 ; } } else { for ( K = 0 ; K <= m ; K ++ ) if ( 
 0 [ K [ c ] ] = = J ) { read ( J , K [ ] , sizeof ( K [ ] ) ) ; x ( J ) ; if ( [ K ] [ 0 ] > = f ) { 0 [ K [ ] 
 ] = 1 [ K [ ] ] = - 1 ; 0 [ K [ c ] ] = 1 [ K [ c ] ] = 0 ; } break ; } } } } } l : close ( G ) ; return T ; } 
